...
highlight Search gui=none guifg=#544060 guibg=#f4dafd ctermbg=1
...
" Syntax group
highlight Comment gui=none guifg=#777777 guibg=bg ctermfg=2
...
highlight Statement gui=bold guifg=#b64f90 guibg=bg ctermfg=White
